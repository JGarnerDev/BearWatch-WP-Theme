...
function adv_theme_support()
{
    ...
    // Featured Image Support (Step 9)
    add_theme_support('post-thumbnails');
}

add_action('after_setup_theme', 'adv_theme_support');

// Widget Locations (Step 18)
...
//  To remove sub-navigation when there is no children (Step 17) 
